...
(check-not-exn       (thunk (And 'rax #xFFFFFFFF)))
...
(check-not-exn       (thunk (Or 'rax #xFFFFFFFF)))
...
(check-not-exn       (thunk (Xor 'rax #xFFFFFFFF)))
...
(check-not-exn       (thunk (Push #xFFFFFFFF)))
...
(check-not-exn       (thunk (Add 'rax #xFFFFFFFF)))
...
(check-not-exn       (thunk (Sub 'rax #xFFFFFFFF)))
...
(check-not-exn       (thunk (Mov 'al #xFF)))
